...
export default function LeaderboardPage() {
  ...
  const getRankIcon = (rank) => {
    switch (rank) {
      case 1:
        return <Trophy className="w-7 h-7 text-yellow-500 drop-" />;
      case 2:
        return <Medal className="w-7 h-7 text-slate-400 drop-" />;
      case 3:
        return <Award className="w-7 h-7 text-orange-600 drop-" />;
      default:
        return (
  ...
  return (
    <>
      {" "}
      <section className="relative overflow-hidden w-full py-12 md:py-16 px-6 md:px-12 bg-white dark:bg-[#262626] border-b border-gray-200 dark:border-[#2f2f2f]">
        {" "}
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="w-full md:w-1/2 max-w-xl text-center md:text-left space-y-3">
            {" "}
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-gray-800 dark:text-gray-200">
              {" "}
              Global Leaderboard{" "}
            </h1>{" "}
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-10 text-center">
          {" "}
          <h1 className="text-4xl font-extrabold mb-3 text-gray-800 dark:text-gray-200 tracking-tight">
            Leaderboard
          </h1>{" "}
        ...
        {/* Leaderboard Table */}{" "}
        <div className="bg-white dark:bg-[#262626] border border-gray-200 dark:border-[#2f2f2f] rounded-xl overflow-hidden ">
          {" "}
          <div className="overflow-x-auto">
            {" "}
            <table className="w-full text-left whitespace-nowrap">
              {" "}
              <thead className="bg-gray-50/80 dark:bg-[#1a1a1a]/40 border-b border-gray-200 dark:border-[#2f2f2f]/50">
                {" "}
                <tr>
                  {" "}
                  <th className="px-6 py-5 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider w-24 text-center">
                    Rank
                  </th>{" "}
                  <th className="px-6 py-5 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    User
                  </th>{" "}
                  <th className="px-6 py-5 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-right">
                    Solved
                  </th>{" "}
                  <th className="px-6 py-5 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-right">
                    Score
