...
const Home = () => {
  ...
  const typingSteps = {
    cpp: [
      ...
      {
        type: "type",
        text: " unordered_map<int, list<pair<int,int>>::iterator> mp;\n",
      },
    ...
    java: [
      ...
      {
        type: "type",
        text: " map = new LinkedHashMap<>(capacity, 0.75f, true);\n",
      },
      { type: "type", text: " }\n\n" },
      ...
      {
        type: "type",
        text: " int firstKey = map.keySet().iterator().next();\n",
      },
    ...
    javascript: [
      ...
      {
        type: "type",
        text: " const firstKey = this.map.keys().next().value;\n",
      },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1a1a1a] text-black dark:text-white">
      ...
      {/* Hero Section */}{" "}
      <div
        className="relative min-h-screen flex items-start pt-24 md:pt-28 pb-24 md:pb-32 bg-white dark:bg-[#1a1a1a] bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/homepage.jpg')" }}
      >
        <div className="absolute inset-0 bg-black/25 dark:bg-black/60" aria-hidden="true" />
        {" "}
        ...
        {/* <div className="absolute inset-0 bg-linear-to-r from-black via-black/80 to-transparent" aria-hidden="true" /> */}{" "}
        <div
          className="absolute -top-24 left-0 h-72 w-72 rounded-full bg-blue-500/20 hidden"
          aria-hidden="true"
        />{" "}
        {/* <div className="absolute bottom-0 right-0 h-80 w-80 rounded-full bg-cyan-500/10 " aria-hidden="true" /> */}{" "}
        <div
          className="absolute top-10 left-10 h-72 w-72 rounded-full bg-blue-500/20 hidden"
          aria-hidden="true"
        />{" "}
        <div
          className="absolute bottom-0 left-0 w-full h-12 bg-linear-to-b from-transparent to-[#1a1a1a]"
          aria-hidden="true"
        />{" "}
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-16 w-full flex items-start justify-start">
          ...
          <div className="max-w-2xl text-left">
            ...
            <div className="flex flex-col gap-6 text-left">
              {" "}
              <p className="inline-flex w-fit items-center rounded-full border border-blue-400/30 bg-white/5 px-4 py-2 text-sm font-medium text-blue-200 ">
                {" "}
              ...
              <div className="mt-8 w-fit rounded-lg p-2 ">
                {" "}
                <div className="flex gap-4">
                  {" "}
                  <Link
                    to="/problems"
                    className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-medium hover: transition-all duration-200 hover:scale-105 text-white"
                  >
                    {" "}
                    Start Solving{" "}
                    <ArrowRight
        ...
        <div className="absolute -bottom-7.5 md:-bottom-10 left-1/2 -translate-x-1/2 w-[90%] max-w-5xl z-20 top-[95%] md:top-[95%] ">
          ...
          <div className="relative p-px rounded-xl">
            {" "}
            <div className="absolute inset-0 rounded-xl border border-gray-200 dark:border-[#2f2f2f]" />{" "}
            <div className="relative bg-gray-100 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-[#2f2f2f] p-4 md:p-6">
              {" "}
              <div className="grid grid-cols-2 divide-y divide-gray-200 dark:divide-gray-700 md:grid-cols-4 md:divide-y-0 md:divide-x divide-x-0">
                ...
                <div className="flex flex-col items-center justify-center py-4 transition-colors duration-200 hover:scale-105 hover:text-blue-400">
                  {" "}
                  <p className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-gray-200 transition-colors duration-200 hover:text-blue-400">
                    500+
                  </p>{" "}
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 items-center py-6 md:grid-cols-2 md:py-10">
          ...
          <div className="order-2 md:order-2">
            ...
            <p className="mt-3 max-w-xl text-gray-600 dark:text-gray-400">
              {" "}
              Practice DSA with structured problems and improve problem-solving
              skills.{" "}
            </p>{" "}
      ...
      <section className="py-20 px-6 lg:px-16 text-center">
        ...
        <div className="max-w-6xl mx-auto">
          {" "}
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-[#2f2f2f] text-white">
            {" "}
          ...
          <p className="mx-auto mt-3 max-w-2xl text-gray-500 dark:text-gray-400">
            {" "}
            Write, run, and iterate in a workspace designed for clarity. Focus
            on solving problems while the platform handles the workflow around
            you.{" "}
          </p>{" "}
